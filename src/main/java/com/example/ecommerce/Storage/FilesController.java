...
//    @GetMapping("/files")
//    public ResponseEntity<List<FileInfo>> getListFilesTiers() {
//        List<FileInfo> fileInfos = storageService.loadAllTiers().map(path -> {
//            String filename = path.getFileName().toString();
//            String url = MvcUriComponentsBuilder
//                    .fromMethodName(FilesController.class, "getFileTiers", path.getFileName().toString()).build().toString();
//
...
//    }
    ...
    @GetMapping("/files/deletefile/{filename:.+}")
    @ResponseBody
